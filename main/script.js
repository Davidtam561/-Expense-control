...
function updateCategoryDropdowns() {
    ...
    // ניקוי הקטגוריות המותאמות אישית הקיימות
    customGroup.innerHTML = '';
    
    // הוספת הקטגוריות המותאמות אישית
...
function showLoader(show) {
    // הוסף לוגיקה להצגת אנימציית טעינה
}

function showNotification(message, type = 'info') {
    // הוסף לוגיקה להצגת התראות
}
...
function showSuccess(message) {
    // הוסף לוגיקה להצגת הודעות הצלחה
}
...
window.onload = function() {
    // בדיקה אם יש משתמש מחובר בlocal storage
